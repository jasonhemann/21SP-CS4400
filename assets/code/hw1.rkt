...
;; The objective is not simply to write programs that get the correct
;; answers; it is to write answers in the style of programs written in
;; class.

;; Please feel free to submit your work as many times as you wish, we
;; will grade the last submission prior to the due date (and time).
