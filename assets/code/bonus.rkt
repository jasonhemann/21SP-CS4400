...
;; and list* problems, it is //not// acceptable to use the and and
;; list* built into Racket in your implementations. Also, don't use
;; match in your solutions.

;; Note: As you work on the following problems, you can use the macro
;; stepper in DrRacket, (syntax->datum (expand <syntax expr>)) and
;; expand-only, or some of the utilities found
...
;; 2. list* cons-es together its arguments. If the final argument is
;; not a list, list* should return an improper list. If a single
...
;; list*"). Your answer should operate similarly to Racket's list*.
