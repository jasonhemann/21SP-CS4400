...
Please find your homeworks listed and available on
handins. From
...
# Assignment Guidelines
   ...
   1. You must use `#lang racket` for this homework.

   1. You must test your solutions before submitting your
      assignment. We have provided some test cases for each exercise
      to get you started, but the provided test cases are not
      exhaustive.

   1. Follow the [design
      recipe](https://web.archive.org/web/20210628043535/https://course.ccs.neu.edu/cs2500/design_recipe.html). If
